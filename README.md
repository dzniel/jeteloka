This repository contains my personal source code for a practicum project that I encountered during my study on Object-Oriented Programming course at [BINUS University](https://binus.ac.id).
